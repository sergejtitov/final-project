...
public class ScoreCardCreditCard implements ScoreCard{
    public int CREDIT_CARD_INITIAL_SCORE;

    public int CREDIT_CARD_GENDER_VALUE_M;
    public int CREDIT_CARD_GENDER_VALUE_F;

    public int EXPERIENCE_CREDIT_CARD_VALUE_LESS_1Y;
    public int EXPERIENCE_CREDIT_CARD_VALUE_MORE_1Y_LESS_3Y;
    public int EXPERIENCE_CREDIT_CARD_VALUE_MORE_3Y_LESS_10Y;
    public int EXPERIENCE_CREDIT_CARD_VALUE_MORE_10Y;

    public int MARITAL_STATUS_CREDIT_CARD_VALUE_SINGLE;
    public int MARITAL_STATUS_CREDIT_CARD_VALUE_MARRIED;
    public int MARITAL_STATUS_CREDIT_CARD_VALUE_DIVORCED;

    public int EDUCATION_CREDIT_CARD_VALUE_MAGISTRACY;
    public int EDUCATION_CREDIT_CARD_VALUE_PHD;
    public int EDUCATION_CREDIT_CARD_VALUE_SECONDARY;
    public int EDUCATION_CREDIT_CARD_VALUE_VOCATIONAL;
    public int EDUCATION_CREDIT_CARD_VALUE_WITHOUT;

    public int CUT_OFF_CREDIT_CARD;
